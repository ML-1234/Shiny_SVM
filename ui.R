...
shinyUI(fluidPage(
  ...
  navbarPage("Support Vector Machine",
             ...
             tabPanel("Démonstration",
                      plotOutput("m_svm", height = 400, width = 350),
                      plotOutput("roc_svm", height = 400, width = 500)),
                        ...
                        tabPanel("Régression logistique",
                                 sidebarLayout(
                                   ...
                                   mainPanel(
                                     ...
                                     plotOutput("confusion_RL", height = 400, width = 350),
  ...
  tabPanel("Random Forest",
           sidebarLayout(
             ...
             mainPanel(
               ...
               plotOutput("confusion_rf", height = 400, width = 350),
  ...
  tabPanel("Gradient Boosting",
            ...
            sidebarLayout(
              sidebarPanel(),
              mainPanel(
                plotOutput("m_gb", height = 400, width = 350),
